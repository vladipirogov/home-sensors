...
class CCS811 {
  public: // Main interface
    CCS811(int nwake=-1, int slaveaddr=CCS811_SLAVEADDR_0, TwoWire *theWire = &Wire);                   // Pin number connected to nWAKE (nWAKE can also be bound to GND, then pass -1), slave address (5A or 5B)
